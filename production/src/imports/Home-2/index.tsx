...
function Frame3() {
  return (
    <div className="absolute gap-x-[98px] gap-y-[98px] grid grid-cols-[repeat(3,fit-content(100%))] grid-rows-[repeat(1,fit-content(100%))] left-[686px] top-[43px] w-[557px]">
      <Frame />
      <Frame1 />
      <Frame2 />
    </div>
...
export default function Home() {
  return (
    <div className="bg-white relative size-full" data-name="Home">
      ...
      <Frame5Variant />
      <div className="absolute flex items-center justify-center left-[-66px] size-[500.883px] top-[-264.7px]">
        <div className="-rotate-45 flex-none">
          <div className="bg-[rgba(217,217,217,0.28)] h-[74.97px] relative w-[633.386px]" />
        </div>
      </div>
      <div className="absolute flex items-center justify-center left-[-12.85px] size-[499.924px] top-[-316px]">
        <div className="-rotate-45 flex-none">
